...
//   const hasData =
//     heroData && heroData.HeroImage && heroData.HeroImage.length > 0;

//   const slides = hasData
//     ? heroData.HeroImage.map((imageSrc) => ({
//         src: imageSrc,
...
//   if (!hasData) {
//     return (
//       <div className="relative w-full h-[100vh] min-h-[600px] overflow-hidden bg-gray-900 animate-pulse" />
//     );
//   }
